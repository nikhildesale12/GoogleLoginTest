...
public class MainActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    private void handleSignInResult(GoogleSignInResult result) {
        ...
        if (result.isSuccess()) {
            ...
            String email = "";
            email = acct.getEmail();
            Intent intent = new Intent(MainActivity.this,SearchPlace.class);
            startActivity(intent);
        } else {
            Toast.makeText(MainActivity.this,"unauthenticated user.."+result.getStatus()+" = "+result,Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public static ArrayList<String> autocomplete(String input) {
        ...
        try {
            ...
            Log.e("SearchPlace", "Error processing Places API URL", e);
            return resultList;
        } catch (IOException e) {
            Log.e("SearchPlace", "Error connecting to Places API", e);
            return resultList;
        } finally {
            if (conn != null) {
                conn.disconnect();
        ...
        try {
            ...
            Log.e("SearchPlace", "Cannot process JSON results", e);
        }
